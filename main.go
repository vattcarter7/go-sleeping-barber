// This is a simple demonstrate of how to solve the Sleeping Barber dilemma, a classic computer science problem
// which illustrate the complexities that arise when there are multiple operating system processes. Here, we have
// a finite number barbers, a finite number of seats in a waiting room, a fixed length of time the barbershop is
...
//			- when the barber finishes a haircut, he inspects the waiting roo to see if there are any waiting customers
//				and falls asleep if there are none
//			- shop can stop accepting new clients at closing time, but the barber cannot leave until the waiting room is
//				empty
//			- after the shop is closed and there are no clients left in the waiting area, the barber goes home

// The Sleeping Barber was originally proposed in 1965 by computer science pioneer Dijkstra.
//
